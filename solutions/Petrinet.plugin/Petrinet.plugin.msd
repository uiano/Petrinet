...
<solution name="Petrinet.plugin" uuid="4b4417a8-ed63-41a0-9044-0b4e14591dae" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/java-cup-11b-runtime.jar" />
    <stubModelEntry path="${module}/java-cup-11b.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
