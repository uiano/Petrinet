...
<solution name="Petrinet.parser" uuid="a695f313-fb68-4d1b-99f9-b01f3baf1635" moduleVersion="0">
  <models>
  ...
  <facets>
    <facet type="java" languageLevel="JAVA_8" compile="mps" classes="mps" ext="no">
      ...
      <library location="${module}/external/java-cup-11b-runtime.jar" />
      <source location="${module}/src" />
    </facet>
  </facets>
  <dependencies>
